            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-collapse">
                    <ul class="navbar-nav mr-auto mt-md-0">
                     ...
                     <li class="nav-item mt-3">ADMIN DASHBOARD</li>
					</ul>
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="{{url('/admin')}}" ><span> <i class="fas fa-home"></i> </span><span class="hide-menu">Admin</span></a></li>
                        ...
                        <li> <a href="{{url('/review')}}" ><span> <i class="far fa-star"></i> </span><span class="hide-menu">Reviews</span></a></li>
